package comp5216.sydney.edu.au.mediaaccess20;
...
public class ActivityWeek05 extends Activity {
    ...
    private void loadPreviewImages() {
        Log.e("loadPreviewImage","Load Images!!!");
    }
    ...
    public Uri getFileUri(String fileName, int type) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                Log.e("getFileUri", "Creating FileUri with FileProvider...");
                fileUri = FileProvider.getUriForFile(
                        this.getApplicationContext(),
                        "comp5216.sydney.edu.au.mediaaccess20.fileProvider", file);
            } else {
                Log.e("getFileUri", "Creating FileUri from file...");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == MY_PERMISSIONS_REQUEST_OPEN_CAMERA) {
            if (resultCode == RESULT_OK) {
                ...
                Log.e("onActivityResult","Intent has been launched successfully!!!");
            } else { // Result was a failure
                Integer number = new Integer(resultCode);
                String numberAsString = number.toString();

                Log.e("ActivityWeek05","Result code is bad:" + numberAsString);

                Toast.makeText(this, "Picture wasn't taken AAAA!",
